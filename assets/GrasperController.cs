...
public class GrasperController : MonoBehaviour
{
    ...
    private GrasperMovement grasper; // Reference to the grasper controller.
    ...
    void Start()
    {
        ...
        grasper = GetComponent<GrasperMovement>();
        print("hi");
        ...
        {
            Debug.LogWarning("Warning: no main camera found. Grasper needs a Camera tagged \"MainCamera\", for camera-relative controls.");
    ...
    void Update()
    {
        ...
        float jump = CrossPlatformInputManager.GetAxis("Jump2");
        print(jump);
    ...
    {
        // Call the Move function of the grasper controller
        grasper.Move(move);
    }
}
